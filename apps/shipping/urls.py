...
router.register('shipping-group-item', ShippingGroupItemViewSet, basename='shipping-group-item')
router.register('shipping-group-tariff', ShippingGroupTariffViewSet, basename='shipping-group-tariff')
